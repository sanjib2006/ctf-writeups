...
This challenge is a very easy challenge, there can be multiple solutions. I will just update the code and call the `print_flag()` function. 
...
```python
      ...
      print_flag()
```
then run the script and enter `b`.
